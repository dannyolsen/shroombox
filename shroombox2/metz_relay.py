...
class heater:
    def on(): #Modbus adressen skal specificeres samt hvilket relæ der ønskes sluttet. State er 1 eller 0
        modbus_adr =3
        relay_no = 0
        state = 1
        #dev_name = "MR-DO4"
    ...
    def off(): #Modbus adressen skal specificeres samt hvilket relæ der ønskes sluttet. State er 1 eller 0
        modbus_adr=3
        relay_no=0
        state = 0
        #dev_name = "MR-DO4"
